...
public class WorkerDaoImplTest {
    ...
    public void testGetWorkersByNeighborhood() {
        ...
        // Exercise
        Set<Worker> retrievedWorkers = workerDao.getWorkers(BASE_PAGE, BASE_PAGE_SIZE, null, neighborhoods, WorkerRole.VERIFIED_WORKER, WorkerStatus.none);
    ...
    public void testGetWorkersByNeighborhoodAndProfessions() {
        ...
        // Exercise
        Set<Worker> retrievedWorkers = workerDao.getWorkers(BASE_PAGE, BASE_PAGE_SIZE, Collections.singletonList(Professions.PLUMBER.name()), neighborhoods, WorkerRole.VERIFIED_WORKER, WorkerStatus.none);
    ...
    public void testGetWorkersByNeighborhoodAndSize() {
        ...
        // Exercise
        Set<Worker> retrievedWorkers = workerDao.getWorkers(BASE_PAGE, 1, null, neighborhoods, WorkerRole.VERIFIED_WORKER, WorkerStatus.none);
    ...
    public void testGetWorkersByNeighborhoodAndSizeAndPage() {
        ...
        // Exercise
        Set<Worker> retrievedWorkers = workerDao.getWorkers(2, 1, null, neighborhoods, WorkerRole.VERIFIED_WORKER, WorkerStatus.none);
