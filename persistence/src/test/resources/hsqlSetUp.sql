...
(
    ...
    profilepictureid INTEGER REFERENCES images
                                                             ON DELETE SET NULL,
...
(
    ...
    channelid INTEGER NOT NULL REFERENCES channels
                                             ON DELETE CASCADE,
    postpictureid INTEGER REFERENCES images
                                             ON DELETE SET NULL
...
(
    ...
    endtimeid INTEGER NOT NULL REFERENCES times
                                                  ON DELETE CASCADE,
    neighborhoodid INTEGER NOT NULL REFERENCES neighborhoods
                                                  ON DELETE CASCADE
    );
