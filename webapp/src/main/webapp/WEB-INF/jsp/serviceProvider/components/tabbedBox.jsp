                        ...
                        <c:otherwise>
                            ...
                            <c:forEach var="review" items="${reviews}" varStatus="loopStatus">
                                ...
                                <span class="font-size-16 font-weight-bold"
                                      id="userNamePlaceholder-${loopStatus.index}">
                                    <spring:message code="Loading."/>
                                </span>
                                        <div>
                                            <span class="post-date"
                                                  data-post-date="<c:out value="${review.date}"/>"></span>
                                            <script src="${pageContext.request.contextPath}/resources/js/dateFormatter.js"></script>
                                        </div>
                                    </div>
                                    <span class="font-size-12"
                                          id="neighborhoodNamePlaceholder-${loopStatus.index}"><spring:message
                                            code="Loading."/></span>
                                    <div class="f-r-c-c">
                                ...
                                <script>
                                    async function fetchUserData(reviewUserId) {
                                        try {
                                            const userNameResponse = await fetch("${pageContext.request.contextPath}/endpoint/user-name?id=" + reviewUserId);
                                            ...
                                            const neighborhoodNameResponse = await fetch("${pageContext.request.contextPath}/endpoint/neighborhood-name?id=" + reviewUserId);
