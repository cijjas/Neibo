                ...
                <form:form method="post" action="publish" modelAttribute="publishForm" enctype="multipart/form-data">
                    ...
                    <div class="form-column" style="margin-top:1rem;">
                        ...
                        <div class="form-group w-50">
                            <form:label path="imageFile" for="images" class="drop-container" id="dropcontainer">
                                ...
                                <form:input class="select-file-button" type="file" id="images" accept="image/*"
                                            path="imageFile" name="imageFile" onchange="preview()"/>
                            </form:label>
                    ...
                    <div class="d-flex justify-content-end">
                        <button onclick="submitForm()" type="submit"
                                class="cool-button cool-small on-bg w-25 font-weight-bolder" style="height:40px;">
                            <spring:message code="Post.verb"/></button>
                    </div>
            ...
            <div id="success-container" class="success-container">
                <div class="cool-static-container small-size-container justify-content-around ">
                    <div>
                        <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 50 50"
                            ...
                            <g clip-path="url(#clip0_259_2)">
                                ...
                                <path d="M38 15L22 33L12 25" stroke="var(--background)" stroke-width="2"
                    ...
                    <div style="text-align:center;font-weight: bold; font-size: 24px; color:var(--old-primary)">
                        <spring:message code="Post.created.successfully"/></div>
                </div>
            </div>
            <script>
