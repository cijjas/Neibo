                    ...
                    <div class="card-block text-center text-white">
                        <div class="m-b-25">
                            <div class="profile-pic">
                                <form:form method="post" action="${pageContext.request.contextPath}/profile"
                                           modelAttribute="profilePictureForm" enctype="multipart/form-data"
                                           id="profilePicForm">
                                    ...
                                    <form:input path="imageFile" id="file" type="file" accept="image/*"
                                                onchange="loadFile()"/>
                                    <c:choose>
                                        <c:when test="${not empty neighbor.profilePicture.imageId }">
                                            <img id="output"
                                                 src="${pageContext.request.contextPath}/images/<c:out value="${neighbor.profilePicture.imageId}"/>"
                                                 alt="profile_picture_img"/>
                                        </c:when>
                                        <c:otherwise>
                                            <img id="output"
                                                 src="${pageContext.request.contextPath}/resources/images/roundedPlaceholder.png"
