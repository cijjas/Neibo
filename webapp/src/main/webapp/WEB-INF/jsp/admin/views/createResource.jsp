    ...
    <div class="row">
        ...
        <div class="column-publish" >
            <div class="cool-static-container" >
                ...
                <form:form method="post" action="/admin/createResource" modelAttribute="resourceForm" enctype="multipart/form-data">
                    ...
                    <div class="form-column" style="margin-top:1rem;">
                        ...
                        <div class="form-group">
                            ...
                            <form:input path="description" class="cool-input" rows="5" placeholder="${descriptionPlaceholder}"/>
                            <div class="form-row form-error">
