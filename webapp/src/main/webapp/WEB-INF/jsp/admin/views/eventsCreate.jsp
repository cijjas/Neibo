                        ...
                        <div class="col-md-4 row">
                            <div class="col-6 pl-0">
                                <form:label path="startTime"
                                            class="c-light-text font-weight-normal mb-1"><spring:message
                                        code="Time.start"/></form:label>
                            ...
                            <div class="col-6 pr-0">
                                <form:label path="endTime" class="c-light-text font-weight-normal mb-1"><spring:message
                                        code="Time.end"/></form:label>
            ...
            <div id="success-container" class="success-container">
                <div class="cool-static-container small-size-container justify-content-around ">
                    ...
                    <div style="text-align:center;font-weight: bold; font-size: 24px; color:var(--old-primary)">
                        <spring:message code="Event.created.successfully"/></div>
                </div>
            </div>
