...
<%--                        </div>--%>
                        ...
                        <div class="col-md-4 row">
                            <div class="col-6 pl-0">
                                <form:label path="startTime" class="c-light-text font-weight-normal mb-1">Start Time</form:label>
                                <form:input path="startTime" type="time" id="appt" required="required" />
                            </div>
                            <div class="col-6 pr-0">
                                <form:label path="endTime" class="c-light-text font-weight-normal mb-1">End Time</form:label>
                                <form:input path="endTime" type="time" id="appt2" required="required" />
                            </div>
                        </div>
                    </div>
