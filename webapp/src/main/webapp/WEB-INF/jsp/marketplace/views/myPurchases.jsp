            ...
            <div class="cool-static-container w-100">
                <div class="f-c-c-c w-100 mb-3">
                    <div class="f-r-c-c w-50 pt-2 pb-2">
                        <a href="${contextPath}/marketplace/my-listings" class="cool-button small-a marketplace-button w-50 font-weight-bold ${channel == "MyPurchases" ? 'active' : ''}">
                        ...
                        <a href="${contextPath}/marketplace/my-requests" class="cool-button small-a marketplace-button w-50 font-weight-bold ${channel == "MyRequests" ? 'active' : ''}">
                        <span class="font-size-12">
