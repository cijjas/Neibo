    ...
    <nav class="navbar navbar-expand-lg custom-navbar">
        <div class="container-xl">
            <div class="d-flex justify-content-between align-items-center w-100">
                <a class="navbar-brand" href="${pageContext.request.contextPath}/${loggedUser.role == 'WORKER' ? 'services' : ''}">
                    <div class="f-r-c-c">
                        ...
                        <div class="f-c-s-s g-0">
                            <h3 class="c-background font-size-24">neibo</h3>
                            <h5>${loggedUser.neighborhood.name} </h5>
                        </div>
                    </div>
