...
import { ProfessionService } from '../../shared/services/index.service';
import { ActivatedRoute, Router } from '@angular/router';
import { Profession } from '../../shared/models';

@Component({
  selector: 'app-upper-service-buttons',
  templateUrl: './upper-service-buttons.component.html',
})
export class UpperServiceButtonsComponent implements OnInit {
