...
import { LinkKey, Neighborhood, NeighborhoodDto, parseLinkHeader } from '@shared/index';
...
export class NeighborhoodService {
    ...
    public getNeighborhoods(
        ...
        let neighborhoodsUrl: string = this.linkService.getLink(LinkKey.NEIGHBORHOODS);
        ...
        return this.http.get<NeighborhoodDto[]>(neighborhoodsUrl, { params, observe: 'response' }).pipe(
            map((response) => {
