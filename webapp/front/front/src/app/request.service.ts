...
export class RequestService {
    ...
    public getRequests(neighborhoodId: number, userId: number, productId: number, page: number, size: number): Observable<RequestForm[]> {
        ...
        return this.http.get<RequestForm[]>(`${this.apiServerUrl}/neighborhoods/${neighborhoodId}/requests`, { params })
    }
