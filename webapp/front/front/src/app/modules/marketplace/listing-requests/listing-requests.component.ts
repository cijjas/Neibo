...
import { Product, Request } from '../../../shared/models';
import { ProductService, RequestService, HateoasLinksService } from '../../../shared/services/index.service';
import { forkJoin } from 'rxjs';

@Component({
  selector: 'app-listing-requests',
  templateUrl: './listing-requests.component.html',
})
export class ListingRequestsComponent implements OnInit {
