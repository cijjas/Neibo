...
import { Department, Request } from '../../../shared/models';  // or your appropriate model interface
import { HateoasLinksService, RequestService } from '../../../shared/services/index.service';

@Component({
  selector: 'app-buyer-hub',
  templateUrl: './buyer-hub.component.html',
})
export class BuyerHubComponent implements OnInit {
