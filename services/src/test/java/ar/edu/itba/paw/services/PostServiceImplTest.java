...
//    private static final String TITLE = "pedro@mcpedro.com";
//    private static final String DESCRIPTION = "Pedro";
...
//        when(mockNeighborhood.getNeighborhoodId()).thenReturn(NEIGHBOR_ID);
//    }
//
//    @Test
...
//        Neighbor newNeighbor = us.createNeighbor(EMAIL, NAME, SURNAME, mockNeighborhood.getNeighborhoodId());
//
//        // 3. Postcondiciones
...
//
//        // 2. Ejercitar
//        Optional<Neighbor> newNeighbor = us.findNeighborById(ID);
//
//        // 3. Postcondiciones
