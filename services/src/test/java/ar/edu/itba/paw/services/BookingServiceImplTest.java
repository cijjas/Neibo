...
public class BookingServiceImplTest {
    ...
    public void testCreate() {
        ...
        when(availabilityDao.findAvailabilityId(AMENITY_ID,SHIFT_ID_1)).thenReturn(Optional.of(AVAILABILITY_ID_1));
        when(availabilityDao.findAvailabilityId(AMENITY_ID,SHIFT_ID_2)).thenReturn(Optional.of(AVAILABILITY_ID_2));
        when(availabilityDao.findAvailabilityId(AMENITY_ID,SHIFT_ID_3)).thenReturn(Optional.of(AVAILABILITY_ID_3));
