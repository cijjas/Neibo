...
public class BookingServiceImplTest {
    ...
    public void testCreate() {
        // 1. Preconditions
        when(availabilityDao.findAvailability(AMENITY_ID, SHIFT_ID_1)).thenReturn(OptionalLong.of(AVAILABILITY_ID_1));
        when(availabilityDao.findAvailability(AMENITY_ID, SHIFT_ID_2)).thenReturn(OptionalLong.of(AVAILABILITY_ID_2));
        when(availabilityDao.findAvailability(AMENITY_ID, SHIFT_ID_3)).thenReturn(OptionalLong.of(AVAILABILITY_ID_3));
